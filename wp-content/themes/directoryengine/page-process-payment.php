        ...
        <div id="order-payment">
            ...
            <div class="invoice-detail">
                <div class="row list-payment-cash">
                    <div class="name">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><?php _e("Invoice no.", ET_DOMAIN); ?></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><?php _e("Date", ET_DOMAIN); ?></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><?php _e("Payment type", ET_DOMAIN); ?></div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><?php _e("Total", ET_DOMAIN); ?></div>
                    </div>
                    <div class="info">
