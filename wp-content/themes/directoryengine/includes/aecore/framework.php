...
class AppEngine extends AE_Base
{
    ...
    public function print_scripts() {
        ...
        $mapUrl = '//maps.googleapis.com/maps/api/js?signed_in=false&libraries=places';
        if(ae_get_option('gg_map_apikey')){
            $mapUrl = '//maps.googleapis.com/maps/api/js?signed_in=false&libraries=places&key='.ae_get_option('gg_map_apikey');
        }
